---
title: "Building Real-Time AI Video Pipelines with ComfyUI and ComfyStream"
description: "Local development guide"
icon: "recycle"
---

This guide walks through setting up a real-time AI video pipeline using ComfyUI and ComfyStream. You'll learn how to process live video with AI models, using depth map generation as an example.
...
2. Configure workspace directories
```bash
